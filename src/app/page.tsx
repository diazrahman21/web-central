            ...
            <FadeInSection>
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                  Layanan profesional Centra Solusi Bisnis sesuai KBLI 69201, 69202, dan 70209
                </p>
              </div>
            </FadeInSection>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-white border border-gray-200 rounded-lg overflow-hidden hover:shadow-xl transition-shadow">
                ...
                <div className="p-6">
                  ...
                  <Link href="/blog/panduan-lengkap-mendirikan-lsp" className="text-primary-600 font-semibold text-sm hover:underline">
                    Baca Selengkapnya →
                  </Link>
                </div>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-lg overflow-hidden hover:shadow-xl transition-shadow">
                ...
                <div className="p-6">
                  ...
                  <Link href="/blog/tips-mengelola-keuangan-umkm" className="text-primary-600 font-semibold text-sm hover:underline">
                    Baca Selengkapnya →
                  </Link>
                </div>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-lg overflow-hidden hover:shadow-xl transition-shadow">
                ...
                <div className="p-6">
                  ...
                  <Link href="/blog/cara-membuka-program-studi-baru" className="text-primary-600 font-semibold text-sm hover:underline">
                    Baca Selengkapnya →
                  </Link>
                </div>
              </div>
